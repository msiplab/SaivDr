...
%
% SVN identifier:
% $Id: fcn_setup_ksvdsbox.m 683 2015-05-29 08:22:13Z sho $
%
...
if exist('ksvdsbox/ksvds.m','file') ~= 2 || ...
    ...
    disp('Downloading and unzipping ksvdsbox11-min.zip...')
    url = 'http://www.cs.technion.ac.il/%7Eronrubin/Software/ksvdsbox11-min.zip';
    disp(url)    
    unzip(url,'./ksvdsbox')
    disp('Done!')
else
