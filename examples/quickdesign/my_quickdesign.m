...
import saivdr.dictionary.cnsoltx.design.CnsoltDictionaryLearning
designer = CnsoltDictionaryLearning(...
...
%%
fileName = sprintf(...
    'results/cnsolt_d%dx%d_c%d_o%d+%d_v%d_l%d_n%d_%s.mat',...
    nDecs(1),nDecs(2),nChs,...
