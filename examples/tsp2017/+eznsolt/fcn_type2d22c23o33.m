function [h,f,E] = fcn_type2d22c23o33(angs,mus,isnodc)
%
% $Id: fcn_type2d22c23o33.m 850 2015-10-29 21:19:55Z sho $
% 
ps = 2;
pa = 3;
pn = min(ps,pa);
...
if isnodc
      ...
      Wi  = step(omgW,angs(1),mus(1:2));
      [ang_,mus_] = step(omf,(W*Wi).');
      angs(aidx)  = ang_(1);
      mus(midx)   = mus_(1);
end
