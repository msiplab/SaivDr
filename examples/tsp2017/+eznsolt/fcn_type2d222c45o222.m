function [h,f,E] = fcn_type2d222c45o222(angs,mus,isnodc)
%
% $Id: fcn_type2d222c45o222.m 850 2015-10-29 21:19:55Z sho $
% 
ps = 4;
pa = 5;
pn = min(ps,pa);
