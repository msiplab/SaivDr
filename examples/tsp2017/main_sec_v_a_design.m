%MAIN_SEC_V_A_DESIGN Example-based design of 2-D NSOLT (fig. 6)
%
% This script was used for the design of 2-D NSOLTs in Section V.A.
...
%
% SVN identifier:
% $Id: main_sec_v_a_design.m 852 2015-10-29 21:42:00Z sho $
%
...
%% Parameters
% d: Downsampling factor (M0 and M1)
% c: # of channels (ps and pa)
% o: # of polyphase order (N0 and N1)
nsoltset = {...
    'd22c22o11',   'd22c22o22',   'd22c22o33',...
    'd22c23o11',   'd22c23o22',   'd22c23o33',...
    'd22c32o11',   'd22c32o22',   'd22c32o33',...
    'd22c33o11',   'd22c33o22',   'd22c33o33',...
    'd22c33o11sep','d22c33o22sep','d22c33o33sep' };
...
imwrite(srcImg,sprintf('tiff/fig%02d.tif',nfig))

%% Produce LaTeX file
sw = StringWriter();
sw.addcr('%#! latex double')
sw.addcr('%')
sw.addcr('% $Id: main_sec_v_a_design.m 852 2015-10-29 21:42:00Z sho $')
sw.addcr('%')
...
sw.addcr('}}')
sw.add('\caption{Training image, part of {\it ')
sw.add(imgName)
sw.add('}, that is ')
sw.add(sprintf('$%d\\times %d$',size(srcImg,1),size(srcImg,2)))
sw.addcr(' pixels in 8-bpp grayscale.}')
