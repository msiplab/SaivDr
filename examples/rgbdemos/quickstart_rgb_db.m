...
linproc = BlurSystem(...  % Instantiation of blur process              
    'BlurType',              blurtype,...
...
imwrite(obsImg,[strrep(sprintf('obs_db_%05.2f',psnr(orgImg,obsImg)),'.','_'),'.png']);
imwrite(resImg,[strrep(sprintf('res_db_%05.2f',psnr(orgImg,resImg)),'.','_'),'.png']);