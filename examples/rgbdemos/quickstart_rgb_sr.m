...
%%
clear psnr
%imwrite(orgImg,'org.png');
imwrite(obsImg,'obs_sr.png');
imwrite(resImg,[strrep(sprintf('res_sr_%05.2f',psnr(orgImg,resImg)),'.','_'),'.png']);

%%

refImg = imresize(obsImg,2,'bicubic');
imwrite(refImg,[strrep(sprintf('ref_sr_%05.2f',psnr(orgImg,refImg)),'.','_'),'.png']);