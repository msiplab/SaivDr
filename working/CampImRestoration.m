classdef CampImRestoration < matlab.System %~#codegen
    %CAMPIMRESTORATION CAMP-based image restoration
    %
    % SVN identifier:
    % $Id: CampImRestoration.m 683 2015-05-29 08:22:13Z sho $
    %
    ...
    methods
        function obj = CampImRestoration(varargin)
...
%             obj.threshold    = s.threshold;
    ...
    methods (Access = private)
        ...
        function procPerIter_(obj)
            ...
            %
            import saivdr.restoration.Camp.CampImRestoration
            if obj.UseParallel
                ...
                parfor iCmp = 1:obj.NumberOfComponents
                    ...
                    y_{iCmp} = CampImRestoration.softshrink_(...
                ...
                for iCmp = 1:obj.NumberOfComponents
                    ...
                    % y = softshrink(y -(1/L)*D.'P.'(^x-x))
                    obj.y(:,iCmp) = CampImRestoration.softshrink_(...
