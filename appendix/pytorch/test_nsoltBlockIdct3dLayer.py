...
class NsoltBlockIdct3dLayerTestCase(unittest.TestCase):
    ...
    Copyright (c) 2020-2021, Shogo MURAMATSU, Yuya Kodama
    ...
    def testPredictGrayScale(self,
        ...
        expctdZ = Y.reshape(nSamples,nComponents,height,width,depth)
    ...
    def testBackwardGrayScale(self,
        ...
        Y = dct.dct_3d(dLdZ.view(arrayshape),norm='ortho')
