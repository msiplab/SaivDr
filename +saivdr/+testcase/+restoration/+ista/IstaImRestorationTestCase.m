classdef IstaImRestorationTestCase < matlab.unittest.TestCase
    %ISTAIMRESTORATIONTESTCASE Test Case for IstaImRestoration
    %
    % SVN identifier:
    % $Id: IstaImRestorationTestCase.m 683 2015-05-29 08:22:13Z sho $
    %
    ...
    methods (Test)
        ...
        function testIstaNsoltDeNoise(testCase)
            ...
            testCase.istaimrstr = IstaImRestoration(...
