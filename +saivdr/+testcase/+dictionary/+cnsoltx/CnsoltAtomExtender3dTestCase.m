classdef CnsoltAtomExtender3dTestCase < matlab.unittest.TestCase
    %NSOLTATOMEXTENDER3DTESTCASE Test case for CnsoltAtomExtender3d
    %
    % SVN identifier:
    % $Id: CnsoltAtomExtender3dTestCase.m 866 2015-11-24 04:29:42Z sho $
    %
