classdef CplxOvsdLpPuFb2dTypeICostEvaluatorTestCase < matlab.unittest.TestCase
    %CplxOvsdLpPuFb2dTypeICostEvaluatorTESTCASE Test case for CplxOvsdLpPuFb2dTypeICostEvaluator
    %
    % SVN identifier:
    % $Id: CplxOvsdLpPuFb2dTypeICostEvaluatorTestCase.m 866 2015-11-24 04:29:42Z sho $
    %
    ...
    methods (Test)
        ...
        function testDefaultConstruction(testCase)
            ...
            testCase.evaluator = CplxOvsdLpPuFb2dTypeICostEvaluator(...
                'LpPuFb',lppufbExpctd);
       ...
       function testInverseBlockDctDec44(testCase)
        ...
        function testStepDec22h44Ord22Vm0Clone(testCase)
            ...
            % Instantiation of target class
            import saivdr.dictionary.cnsoltx.design.*
            evaluator_ = CplxOvsdLpPuFb2dTypeICostEvaluator(...
                'LpPuFb',lppufb);
    ...
    methods (Access = public, Static = true)
        ...
        function grad = gradient(lppufb,srcImg,coefs,scales,isPext,delta)
            ...
            % Preparation
            import saivdr.dictionary.cnsoltx.*
            synCur = CnsoltFactory.createSynthesis2dSystem(lppufb,...
                'IsCloneLpPuFb2d',true);
            if isPext
            ...
            synDlt = CnsoltFactory.createSynthesis2dSystem(clonefb,...
                'IsCloneLpPuFb2d',false);
            if isPext
