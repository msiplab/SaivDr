classdef CnsoltAnalysisSynthesisTestCase < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function testDec22Ch22Ord22Level1(testCase)
            ...
            % Preparation
            vm = 1;
            lppufb = saivdr.dictionary.nsoltx.CnsoltFactory.createCplxOvsdLpPuFb2dSystem(...
                'DecimationFactor', nDecs,...
                'NumberOfChannels', nChs,...
                'PolyPhaseOrder', nOrds,...
                'NumberOfVanishingMoments', vm,...
            ...
            testCase.synthesizer = saivdr.dictionary.nsoltx.CnsoltFactory.createSynthesis2dSystem(...
                lppufb,'BoundaryOperation','Termination');
            testCase.analyzer    = saivdr.dictionary.nsoltx.CnsoltFactory.createAnalysis2dSystem(...
                lppufb,'BoundaryOperation','Termination');
