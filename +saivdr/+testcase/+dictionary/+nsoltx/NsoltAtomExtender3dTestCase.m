classdef NsoltAtomExtender3dTestCase < matlab.unittest.TestCase
    %NSOLTATOMEXTENDER3DTESTCASE Test case for NsoltAtomExtender3d
    %
    % SVN identifier:
    % $Id: NsoltAtomExtender3dTestCase.m 866 2015-11-24 04:29:42Z sho $
    %
    ...
    methods(Test)
        ...
        function testDefaultConstraction(testCase)
            ...
            % Instantiation
            import saivdr.dictionary.nsoltx.NsoltAtomExtender3d
            testCase.module = NsoltAtomExtender3d();
