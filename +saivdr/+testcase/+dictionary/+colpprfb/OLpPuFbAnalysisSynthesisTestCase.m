classdef OLpPuFbAnalysisSynthesisTestCase < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function testDec4Ch22Ord2Level1(testCase)
            ...
            % Preparation
            vm = 1;
            lppufb = saivdr.dictionary.colpprfb.OLpPrFbFactory.createOvsdLpPuFb1dSystem(...
                'DecimationFactor', nDecs,...
                'NumberOfChannels', nChs,...
                'PolyPhaseOrder', nOrds,...
                'NumberOfVanishingMoments', vm,...
            ...
            testCase.synthesizer = saivdr.dictionary.colpprfb.OLpPrFbFactory.createSynthesis1dSystem(...
                lppufb,'BoundaryOperation','Termination');
            testCase.analyzer    = saivdr.dictionary.colpprfb.OLpPrFbFactory.createAnalysis1dSystem(...
                lppufb,'BoundaryOperation','Termination');
