classdef CplxOLpPuFbSynthesis1dSystemTestCase < matlab.unittest.TestCase
    %CplxOLpPuFbSynthesis1dSystemTESTCASE Test case for CplxOLpPuFbSynthesis1dSystem
    %
    % SVN identifier:
    % $Id: CplxOLpPuFbSynthesis1dSystemTestCase.m 683 2015-05-29 08:22:13Z sho $
    %
    ...
    methods (Test)
        ...
        function testDefaultConstruction(testCase)
            ...
            % Instantiation
            testCase.synthesizer = CplxOLpPuFbSynthesis1dSystem();
        ...
        function testDefaultConstruction4plus4(testCase)
            ...
            testCase.synthesizer = CplxOLpPuFbAnalysis1dSystem(...
                'NumberOfChannels',nChs);
        ...
        function testInverseBlockDctDec4(testCase)
            ...
            ch = dec;
            nLen = 32;
            subCoefs = rand(dec,nLen/dec) + 1i*rand(dec,nLen/dec);
            coefs = zeros(1,nLen);
            scales = zeros(ch,1);
            sIdx = 1;
            for iCh = 1:dec
        ...
        function testStepDec2Ch4Ord0(testCase)
        ...
        function testStepDec2Ch11Ord2(testCase)
            ...
            sIdx = 1;
            for iSubband = 1:dec
                subSeq = rand(1,nLen/dec) + 1i*rand(1,nLen/dec);
        ...
        % Test
        function testStepDec4Ch4Ord2(testCase)
        ...
        % Test
        function testStepDec4Ch4Ord2PeriodicExtVm0(testCase)
        ...
        % Test
        function testStepDec4Ch4Ord2PeriodicExtVm1(testCase)
        ...
        function testInverseBlockDctOrd2(testCase)
            ...
            % Expected values
            E0 = step(CplxOLpPrFbFactory.createCplxOvsdLpPuFb1dSystem(...
                'DecimationFactor',dec),[],[]);
        ...
        % Test
        function testStepDec4Ch4Ord4(testCase)
        ...
        % Test
        function testStepDec4Ch4Ord4PeriodicExt(testCase)
        ...
        function testInverseBlockDctOrd4Dec4(testCase)
            ...
            set(lppufb,'OutputMode','SynthesisFilterAt');
            E0 = step(...
                CplxOLpPrFbFactory.createCplxOvsdLpPuFb1dSystem(...
                'DecimationFactor',dec),[],[]);
            tmp = flipud(E0'*cell2mat(subCoefs));
            seqExpctd = tmp(:).';
        ...
        % Test
        function testStepDec4Ch4Ord6(testCase)
        ...
        % Test
        function testStepDec4Ch4Ord6PeriodicExt(testCase)
        ...
        % Test for boundary operation
        function testInverseBlockDctDec4Ch4Ord6(testCase)
        ...
        % Test
        function testStepDec4Ch4Ord2PeriodicExt(testCase)
        ...
        % Test
        function testStepDec2Ch4Ord2PeriodicExt(testCase)
        ...
        %Dec2Ch8Ord2
        function testStepDec2Ch8Ord2(testCase)
        ...
        function testStepDec11Ch4Ord0Level2(testCase)
            ...
            subCoefs{1} = rand(1,nLen/(dec^2)) + 1i*rand(1,nLen/(dec^2));
            subCoefs{2} = rand(1,nLen/(dec^2)) + 1i*rand(1,nLen/(dec^2));
            subCoefs{3} = rand(1,nLen/(dec^2)) + 1i*rand(1,nLen/(dec^2));
            subCoefs{4} = rand(1,nLen/(dec^2)) + 1i*rand(1,nLen/(dec^2));
            subCoefs{5} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{6} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{7} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
        ...
        function testStepDec2Ch6Ord0Level2(testCase)
            ...
            subCoefs{3} = rand(1,nLen/(dec^2)) + 1i*rand(1,nLen/(dec^2));
            subCoefs{4} = rand(1,nLen/(dec^2)) + 1i*rand(1,nLen/(dec^2));
            subCoefs{5} = rand(1,nLen/(dec^2)) + 1i*rand(1,nLen/(dec^2));
            subCoefs{6} = rand(1,nLen/(dec^2)) + 1i*rand(1,nLen/(dec^2));
            subCoefs{7} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{8} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{9} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{10} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{11} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            nSubbands = length(subCoefs);
            scales = zeros(nSubbands,1);
            sIdx = 1;
            for iSubband = 1:nSubbands
        ...
        function testStepDec2Ch8Ord0Level2(testCase)
            ...
            subCoefs{5} = rand(1,nLen/(dec^2)) + 1i*rand(1,nLen/(dec^2));
            subCoefs{6} = rand(1,nLen/(dec^2)) + 1i*rand(1,nLen/(dec^2));
            subCoefs{7} = rand(1,nLen/(dec^2)) + 1i*rand(1,nLen/(dec^2));
            subCoefs{8} = rand(1,nLen/(dec^2)) + 1i*rand(1,nLen/(dec^2));
            subCoefs{9} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{10} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{11} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{12} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{13} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{14} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{15} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            nSubbands = length(subCoefs);
            scales = zeros(nSubbands,1);
            sIdx = 1;
            for iSubband = 1:nSubbands
        ...
        function testStepDec2Ch8Ord4Level3PeriodicExt(testCase)
            ...
            nLevels = 3;
            subCoefs = cell(nLevels*(ch-1)+1,1);
            subCoefs{1} = rand(1,nLen/(dec^3)) + 1i*rand(1,nLen/(dec^3));
            subCoefs{2} = rand(1,nLen/(dec^3)) + 1i*rand(1,nLen/(dec^3));
            subCoefs{3} = rand(1,nLen/(dec^3)) + 1i*rand(1,nLen/(dec^3));
            subCoefs{4} = rand(1,nLen/(dec^3)) + 1i*rand(1,nLen/(dec^3));
            subCoefs{5} = rand(1,nLen/(dec^3)) + 1i*rand(1,nLen/(dec^3));
            subCoefs{6} = rand(1,nLen/(dec^3)) + 1i*rand(1,nLen/(dec^3));
            subCoefs{7} = rand(1,nLen/(dec^3)) + 1i*rand(1,nLen/(dec^3));
            subCoefs{8} = rand(1,nLen/(dec^3)) + 1i*rand(1,nLen/(dec^3));
            subCoefs{9} = rand(1,nLen/(dec^2)) + 1i*rand(1,nLen/(dec^2));
            subCoefs{10} = rand(1,nLen/(dec^2)) + 1i*rand(1,nLen/(dec^2));
            subCoefs{11} = rand(1,nLen/(dec^2)) + 1i*rand(1,nLen/(dec^2));
            subCoefs{12} = rand(1,nLen/(dec^2)) + 1i*rand(1,nLen/(dec^2));
            subCoefs{13} = rand(1,nLen/(dec^2)) + 1i*rand(1,nLen/(dec^2));
            subCoefs{14} = rand(1,nLen/(dec^2)) + 1i*rand(1,nLen/(dec^2));
            subCoefs{15} = rand(1,nLen/(dec^2)) + 1i*rand(1,nLen/(dec^2));
            subCoefs{16} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{17} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{18} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{19} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{20} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{21} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{22} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            nSubbands = length(subCoefs);
            scales = zeros(nSubbands,1);
            sIdx = 1;
            for iSubband = 1:nSubbands
        ...
        function testSetLpPuFb1dDec2Ch4Ord4(testCase)
            
            dec = 2;
            decch = [ dec 4 4 ];
            ord = 4;
            nLen = 32;
            subCoefs{1} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{2} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{3} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{4} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{5} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{6} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{7} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{8} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
        ...
        function testClone(testCase)
            ...
            ord  = 4;
            nLen = 64;
            coefs = rand(1,nLen*sum(ch)/dec) + 1i*rand(1,nLen*sum(ch)/dec);
...
%         end
        ...
        function testStepDec2Ch5Ord0(testCase)
            ...
            nChs = 5;
            nLen = 16;
            subCoefs = rand(nChs,nLen/dec) + 1i*rand(nChs,nLen/dec);
            coefs = zeros(1,nLen);
            scales = zeros(dec,1);
            sIdx = 1;
            for iCh = 1:nChs
        ...
        function testStepDec2Ch9Ord4Level3PeriodicExt(testCase)
            ...
            subCoefs{7} = rand(1,nLen/(dec^3)) + 1i*rand(1,nLen/(dec^3));
            subCoefs{8} = rand(1,nLen/(dec^3)) + 1i*rand(1,nLen/(dec^3));
            subCoefs{9} = rand(1,nLen/(dec^3)) + 1i*rand(1,nLen/(dec^3));
            subCoefs{10} = rand(1,nLen/(dec^2)) + 1i*rand(1,nLen/(dec^2));
            subCoefs{11} = rand(1,nLen/(dec^2)) + 1i*rand(1,nLen/(dec^2));
            subCoefs{12} = rand(1,nLen/(dec^2)) + 1i*rand(1,nLen/(dec^2));
            subCoefs{13} = rand(1,nLen/(dec^2)) + 1i*rand(1,nLen/(dec^2));
            subCoefs{14} = rand(1,nLen/(dec^2)) + 1i*rand(1,nLen/(dec^2));
            subCoefs{15} = rand(1,nLen/(dec^2)) + 1i*rand(1,nLen/(dec^2));
            subCoefs{16} = rand(1,nLen/(dec^2)) + 1i*rand(1,nLen/(dec^2));
            subCoefs{17} = rand(1,nLen/(dec^2)) + 1i*rand(1,nLen/(dec^2));
            subCoefs{18} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{19} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{20} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{21} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{22} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{23} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{24} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            subCoefs{25} = rand(1,nLen/(dec)) + 1i*rand(1,nLen/(dec));
            nSubbands = length(subCoefs);
            scales = zeros(nSubbands,1);
            sIdx = 1;
            for iSubband = 1:nSubbands
...
%             subCoefs{1} = rand(1,nLen/(decch(1)^2)) + 1i*rand(1,nLen/(decch(1)^2));
%             subCoefs{2} = rand(1,nLen/(decch(1)^2)) + 1i*rand(1,nLen/(decch(1)^2));
%             subCoefs{3} = rand(1,nLen/(decch(1)^2)) + 1i*rand(1,nLen/(decch(1)^2));
%             subCoefs{4} = rand(1,nLen/(decch(1)^2)) + 1i*rand(1,nLen/(decch(1)^2));
%             subCoefs{5} = rand(1,nLen/(decch(1)^2)) + 1i*rand(1,nLen/(decch(1)^2));
%             subCoefs{6} = rand(1,nLen/decch(1)) + 1i*rand(1,nLen/(decch(1)));
%             subCoefs{7} = rand(1,nLen/decch(1)) + 1i*rand(1,nLen/(decch(1)));
%             subCoefs{8} = rand(1,nLen/decch(1)) + 1i*rand(1,nLen/(decch(1)));
%             subCoefs{9} = rand(1,nLen/decch(1)) + 1i*rand(1,nLen/(decch(1)));
%             nSubbands = length(subCoefs);
%             scales = zeros(nSubbands,1);
%             sIdx = 1;
%             for iSubband = 1:nSubbands
