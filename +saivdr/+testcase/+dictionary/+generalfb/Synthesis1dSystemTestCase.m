classdef Synthesis1dSystemTestCase < matlab.unittest.TestCase
    %SYNTHESIS1DSYSTEMTESTCASE Test case for Synthesis1dSystem
    %
    ...
    methods (Test)
        ...
        function testDefaultConstruction(testCase)
            ...
            decimationFactorExpctd = 2;
            frmbdExpctd  = [];
            filterDomainExpctd = 'Spatial';
            boundaryOperationExpctd = 'Circular';            
            
            % Instantiation
            testCase.synthesizer = Synthesis1dSystem();
