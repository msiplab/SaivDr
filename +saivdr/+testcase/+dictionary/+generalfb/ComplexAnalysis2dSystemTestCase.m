classdef ComplexAnalysis2dSystemTestCase < matlab.unittest.TestCase
    %ComplexAnalysis2dSystemTESTCASE Test case for ComplexAnalysis2dSystem
    %
    % SVN identifier:
    % $Id: ComplexAnalysis2dSystemTestCase.m 866 2015-11-24 04:29:42Z sho $
    %
    ...
    methods (Test)
        ...
        function testAnalysisFilters(testCase)
            ...
            % Expected values
            analysisFiltersExpctd(:,:,1) = randn(2,2).*exp(1i*2*pi*rand(2,2));
            analysisFiltersExpctd(:,:,2) = randn(2,2).*exp(1i*2*pi*rand(2,2));
            analysisFiltersExpctd(:,:,3) = randn(2,2).*exp(1i*2*pi*rand(2,2));
            analysisFiltersExpctd(:,:,4) = randn(2,2).*exp(1i*2*pi*rand(2,2));
        ...
        function testStepDec22Ch22Ord00Level1(testCase)
            ...
            nDecs = [ 2 2 ]; 
            analysisFilters(:,:,1) = randn(2,2).*exp(1i*2*pi*rand(2,2));
            analysisFilters(:,:,2) = randn(2,2).*exp(1i*2*pi*rand(2,2));
            analysisFilters(:,:,3) = randn(2,2).*exp(1i*2*pi*rand(2,2));
            analysisFilters(:,:,4) = randn(2,2).*exp(1i*2*pi*rand(2,2));
            nLevels = 1;
        ...
        function testStepDec22Ch33Ord00Level1(testCase)
            ...
            analysisFilters(:,:,3) = randn(2,2).*exp(1i*2*pi*rand(2,2));
            analysisFilters(:,:,4) = randn(2,2).*exp(1i*2*pi*rand(2,2));
            analysisFilters(:,:,5) = randn(2,2).*exp(1i*2*pi*rand(2,2));
            analysisFilters(:,:,6) = randn(2,2).*exp(1i*2*pi*rand(2,2));            
            nLevels = 1;
        ...
        function testStepDec22Ch33Ord22Level1(testCase)
            ...
            srcImg = rand(height,width);
            nDecs = [ 2 2 ]; 
            analysisFilters(:,:,1) = randn(6,6).*exp(1i*2*pi*rand(6,6));
            analysisFilters(:,:,2) = randn(6,6).*exp(1i*2*pi*rand(6,6));
            analysisFilters(:,:,3) = randn(6,6).*exp(1i*2*pi*rand(6,6));
            analysisFilters(:,:,4) = randn(6,6).*exp(1i*2*pi*rand(6,6));
            analysisFilters(:,:,5) = randn(6,6).*exp(1i*2*pi*rand(6,6));
            analysisFilters(:,:,6) = randn(6,6).*exp(1i*2*pi*rand(6,6));            
            nLevels = 1;
        ...
        function testStepDec33Ch54Ord22Level1(testCase)
            ...
            srcImg = rand(height,width);
            nDecs = [ 3 3 ]; 
            analysisFilters(:,:,1) = randn(9,9).*exp(1i*2*pi*rand(9,9));
            analysisFilters(:,:,2) = randn(9,9).*exp(1i*2*pi*rand(9,9));
            analysisFilters(:,:,3) = randn(9,9).*exp(1i*2*pi*rand(9,9));
            analysisFilters(:,:,4) = randn(9,9).*exp(1i*2*pi*rand(9,9));
            analysisFilters(:,:,5) = randn(9,9).*exp(1i*2*pi*rand(9,9));
            analysisFilters(:,:,6) = randn(9,9).*exp(1i*2*pi*rand(9,9));
            analysisFilters(:,:,7) = randn(9,9).*exp(1i*2*pi*rand(9,9));
            analysisFilters(:,:,8) = randn(9,9).*exp(1i*2*pi*rand(9,9));
            analysisFilters(:,:,9) = randn(9,9).*exp(1i*2*pi*rand(9,9));            
            nLevels = 1;
        ...
        function testStepDec44Ch1212Ord22Level1(testCase)
            ...
            for iCh = 1:24
                analysisFilters(:,:,iCh) = randn(12,12).*exp(1i*2*pi*rand(12,12));
            end
            nLevels = 1;
        ...
        function testStepDec22Ch44Ord44Level3(testCase)
            ...
            srcImg = rand(height,width);
            nDecs = [ 2 2 ];
            analysisFilters(:,:,1) = randn(10,10).*exp(1i*2*pi*rand(10,10));
            analysisFilters(:,:,2) = randn(10,10).*exp(1i*2*pi*rand(10,10));
            analysisFilters(:,:,3) = randn(10,10).*exp(1i*2*pi*rand(10,10));
            analysisFilters(:,:,4) = randn(10,10).*exp(1i*2*pi*rand(10,10));
            analysisFilters(:,:,5) = randn(10,10).*exp(1i*2*pi*rand(10,10));
            analysisFilters(:,:,6) = randn(10,10).*exp(1i*2*pi*rand(10,10));
            analysisFilters(:,:,7) = randn(10,10).*exp(1i*2*pi*rand(10,10));
            analysisFilters(:,:,8) = randn(10,10).*exp(1i*2*pi*rand(10,10));
            nLevels = 3;
