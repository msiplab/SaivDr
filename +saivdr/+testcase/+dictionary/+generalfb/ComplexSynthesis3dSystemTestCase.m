classdef ComplexSynthesis3dSystemTestCase < matlab.unittest.TestCase
    %ComplexSynthesis3dSystemTESTCASE Test case for ComplexSynthesis3dSystem
    %
    % SVN identifier:
    % $Id: ComplexSynthesis3dSystemTestCase.m 866 2015-11-24 04:29:42Z sho $
    %
    ...
    methods (Test)
        ...
        function testSynthesisFilters(testCase)
            ...
            % Expected values
            synthesisFiltersExpctd(:,:,:,1) = randn(2,2,2).*exp(1i*2*pi*rand(2,2,2));
            synthesisFiltersExpctd(:,:,:,2) = randn(2,2,2).*exp(1i*2*pi*rand(2,2,2));
            synthesisFiltersExpctd(:,:,:,3) = randn(2,2,2).*exp(1i*2*pi*rand(2,2,2));
            synthesisFiltersExpctd(:,:,:,4) = randn(2,2,2).*exp(1i*2*pi*rand(2,2,2));
            synthesisFiltersExpctd(:,:,:,5) = randn(2,2,2).*exp(1i*2*pi*rand(2,2,2));
            synthesisFiltersExpctd(:,:,:,6) = randn(2,2,2).*exp(1i*2*pi*rand(2,2,2));
            synthesisFiltersExpctd(:,:,:,7) = randn(2,2,2).*exp(1i*2*pi*rand(2,2,2));
            synthesisFiltersExpctd(:,:,:,8) = randn(2,2,2).*exp(1i*2*pi*rand(2,2,2));            
        ...
        function testStepDec222Ch44Ord000Level1(testCase)
            ...
            depth = 32;
            nDecs = [ 2 2 2 ];
            synthesisFilters(:,:,:,1) = randn(2,2,2).*exp(1i*2*pi*rand(2,2,2));
            synthesisFilters(:,:,:,2) = randn(2,2,2).*exp(1i*2*pi*rand(2,2,2));
            synthesisFilters(:,:,:,3) = randn(2,2,2).*exp(1i*2*pi*rand(2,2,2));
            synthesisFilters(:,:,:,4) = randn(2,2,2).*exp(1i*2*pi*rand(2,2,2));
            synthesisFilters(:,:,:,5) = randn(2,2,2).*exp(1i*2*pi*rand(2,2,2));
            synthesisFilters(:,:,:,6) = randn(2,2,2).*exp(1i*2*pi*rand(2,2,2));
            synthesisFilters(:,:,:,7) = randn(2,2,2).*exp(1i*2*pi*rand(2,2,2));
            synthesisFilters(:,:,:,8) = randn(2,2,2).*exp(1i*2*pi*rand(2,2,2));            
            %nLevels = 1;
        ...
        function testStepDec222Ch54Ord000Level1(testCase)
            ...
            synthesisFilters(:,:,:,7) = randn(2,2,2).*exp(1i*2*pi*rand(2,2,2));
            synthesisFilters(:,:,:,8) = randn(2,2,2).*exp(1i*2*pi*rand(2,2,2));            
            synthesisFilters(:,:,:,9) = randn(2,2,2).*exp(1i*2*pi*rand(2,2,2));            
            %nLevels = 1;
        ...
        function testStepDec222Ch54Ord222Level1(testCase)
            ...
            depth = 32;
            nDecs = [ 2 2 2 ];
            synthesisFilters(:,:,:,1) = randn(6,6,6).*exp(1i*2*pi*rand(6,6,6));
            synthesisFilters(:,:,:,2) = randn(6,6,6).*exp(1i*2*pi*rand(6,6,6));
            synthesisFilters(:,:,:,3) = randn(6,6,6).*exp(1i*2*pi*rand(6,6,6));
            synthesisFilters(:,:,:,4) = randn(6,6,6).*exp(1i*2*pi*rand(6,6,6));
            synthesisFilters(:,:,:,5) = randn(6,6,6).*exp(1i*2*pi*rand(6,6,6));
            synthesisFilters(:,:,:,6) = randn(6,6,6).*exp(1i*2*pi*rand(6,6,6));
            synthesisFilters(:,:,:,7) = randn(6,6,6).*exp(1i*2*pi*rand(6,6,6));
            synthesisFilters(:,:,:,8) = randn(6,6,6).*exp(1i*2*pi*rand(6,6,6));
            synthesisFilters(:,:,:,9) = randn(6,6,6).*exp(1i*2*pi*rand(6,6,6));
            %nLevels = 1;
        ...
        function testStepDec321Ch44Ord222Level1(testCase)
            ...
            depth = 32;
            nDecs = [ 3 2 1 ];
            synthesisFilters(:,:,:,1) = randn(9,6,3).*exp(1i*2*pi*rand(9,6,3));
            synthesisFilters(:,:,:,2) = randn(9,6,3).*exp(1i*2*pi*rand(9,6,3));
            synthesisFilters(:,:,:,3) = randn(9,6,3).*exp(1i*2*pi*rand(9,6,3));
            synthesisFilters(:,:,:,4) = randn(9,6,3).*exp(1i*2*pi*rand(9,6,3));
            synthesisFilters(:,:,:,5) = randn(9,6,3).*exp(1i*2*pi*rand(9,6,3));
            synthesisFilters(:,:,:,6) = randn(9,6,3).*exp(1i*2*pi*rand(9,6,3));
            synthesisFilters(:,:,:,7) = randn(9,6,3).*exp(1i*2*pi*rand(9,6,3));
            synthesisFilters(:,:,:,8) = randn(9,6,3).*exp(1i*2*pi*rand(9,6,3));
            synthesisFilters(:,:,:,9) = randn(9,6,3).*exp(1i*2*pi*rand(9,6,3));
            %nLevels = 1;
        ...
        function testStepDec234Ch1414Ord222Level1(testCase)
            ...
            for iCh = 1:28
                synthesisFilters(:,:,:,iCh) = randn(6,9,12).*exp(1i*2*pi*rand(6,9,12));
            end
            nLevels = 1;
