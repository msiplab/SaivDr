classdef CplxOLpPuFbAnalysisSynthesisTestCase < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function testDec4Ch22Ord2Level1(testCase)
            ...
            % Preparation
            vm = 1;
            lppufb = saivdr.dictionary.olpprfb.CplxOLpPrFbFactory.createCplxOvsdLpPuFb1dSystem(...
                'DecimationFactor', nDecs,...
                'NumberOfChannels', nChs,...
                'PolyPhaseOrder', nOrds,...
                'NumberOfVanishingMoments', vm,...
            ...
            testCase.synthesizer = saivdr.dictionary.olpprfb.CplxOLpPrFbFactory.createSynthesis1dSystem(...
                lppufb,'BoundaryOperation','Termination');
            testCase.analyzer    = saivdr.dictionary.olpprfb.CplxOLpPrFbFactory.createAnalysis1dSystem(...
                lppufb,'BoundaryOperation','Termination');
