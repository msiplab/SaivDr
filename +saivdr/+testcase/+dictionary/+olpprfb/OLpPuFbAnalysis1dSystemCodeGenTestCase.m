classdef OLpPuFbAnalysis1dSystemCodeGenTestCase < matlab.unittest.TestCase
    %OLPPUFBANALYSIS1DSYSTEMCODEGENTESTCASE Test case for
    %OLpPuFbAnalysis1dSystemCodeGen
    %
    ...
    methods (Test)
        ...
        function testDefaultConstruction4plus4(testCase)
            ...
            testCase.analyzer = OLpPuFbAnalysis1dSystemCodeGen(...
