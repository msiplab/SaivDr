    ...
    methods (Access=protected)
        ...
        function setupImpl(obj, ~, ~)
            ...
            if obj.NumberOfSymmetricChannels == 1 || ...
                ...
                mexFcn = [];
            elseif ~obj.isMexFcn
                import saivdr.dictionary.olpprfb.mexsrcs.fcn_autobuild_catomcnc1d
                [mexFcn, obj.isMexFcn] = ...
            ...
            if ~isempty(mexFcn)
                ...
                import saivdr.dictionary.olpprfb.mexsrcs.fcn_CplxOLpPrFbAtomConcatenator1d
