function [fcnhandler,flag] = fcn_autobuild_catomext1d(nch)
%FCN_AUTOBUILD_ATOMEXT1D
%
% SVN identifier:
% $Id: fcn_autobuild_atomext1d.m 683 2015-05-29 08:22:13Z sho $
%
...
% global isAutoBuildAtomExt1dLocked
% if isempty(isAutoBuildAtomExt1dLocked)
%     isAutoBuildAtomExt1dLocked = false;
% end

bsfname = 'fcn_CplxOLpPrFbAtomExtender1d';
...
%    isAutoBuildAtomExt1dLocked = true;
    if ftypemex ~= 3  && ... % MEX file doesn't exist
        ...
        if fbsfile == 2
            ...
            %
            aCoefs   = coder.typeof(complex(double(0)),[sum(nch) Inf],[0 1]); %#ok
