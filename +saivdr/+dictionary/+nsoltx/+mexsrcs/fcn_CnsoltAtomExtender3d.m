function coefs = fcn_CnsoltAtomExtender3d( coefs, scale, pmcoefs, ...
    nch, ord, fpe ) %#codegen
% FCN_NSOLTX_SUPEXT_TYPE1
%
% SVN identifier:
% $Id: fcn_NsoltAtomExtender3d.m 683 2015-05-29 08:22:13Z sho $
%
...
persistent h;
if isempty(h)
    h = saivdr.dictionary.nsoltx.CnsoltAtomExtender3d(...
