classdef NsoltVQStep3d <  ...
    ...
    methods
        ...
        % Constructor
        function obj = NsoltVQStep3d(varargin)
    ...
    methods (Access = protected)
        ...
        function setupImpl(obj, arrayCoefs, subScale, pmCoefs, ~)
            setupImpl@saivdr.dictionary.nsoltx.AbstNsoltCoefManipulator3d(obj,arrayCoefs,subScale,pmCoefs);
        end
