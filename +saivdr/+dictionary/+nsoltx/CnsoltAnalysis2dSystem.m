classdef CnsoltAnalysis2dSystem < ...
    ...
    methods
        ...
        function obj = CnsoltAnalysis2dSystem(varargin)
            ...
            if isempty(obj.LpPuFb2d)
                ...
                obj.LpPuFb2d = NsoltFactory.createCplxOvsdLpPuFb2dSystem(...
                    'NumberOfChannels', ...
    ...
    methods (Access=protected)
        ...
        function setupImpl(obj, srcImg, nLevels)
            ...
            if ~obj.isMexFcn
                import saivdr.dictionary.nsoltx.mexsrcs.fcn_autobuild_catomext2d
                [mexFcn, obj.isMexFcn] = ...
            ...
            if ~isempty(mexFcn)
                ...
                import saivdr.dictionary.nsoltx.mexsrcs.fcn_CnsoltAtomExtender2d
