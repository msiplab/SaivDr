classdef SupportExtensionVerticalTypeII < matlab.System %#codegen
    %SUPPORTEXTENSIOVERTICALTYPEII Type-II Vertical support extension
    %
    % SVN identifier:
    % $Id: SupportExtensionVerticalTypeII.m 683 2015-05-29 08:22:13Z sho $
    %
    ...
    methods
        function obj = SupportExtensionVerticalTypeII(varargin)
