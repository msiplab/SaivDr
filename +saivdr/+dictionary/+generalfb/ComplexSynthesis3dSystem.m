classdef ComplexSynthesis3dSystem < saivdr.dictionary.AbstSynthesisSystem
    %COMPLEXSYNTHESIS3DSYSTEM 3-D synthesis system
    %
    % Reference:
    ...
    methods
        ...
        % Constractor
        function obj = ComplexSynthesis3dSystem(varargin)
