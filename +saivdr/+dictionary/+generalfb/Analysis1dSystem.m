classdef Analysis1dSystem < saivdr.dictionary.AbstAnalysisSystem 
    %ANALYSIS1DSYSTEM 1-D analysis system
    %
    ...
    methods
        % Constractor
        function obj = Analysis1dSystem(varargin)
            import saivdr.dictionary.AbstAnalysisSystem 
            obj = obj@saivdr.dictionary.AbstAnalysisSystem(...
                varargin{:});      
            if isempty(obj.AnalysisFilters)
                obj.nChs = 1;
            else
                obj.nChs = size(obj.AnalysisFilters,2);
            end
        end        
    end
