classdef Synthesis1dSystem < saivdr.dictionary.AbstSynthesisSystem
    %SYNTHESIS1DSYSTEM 1-D synthesis system
    %
    ...
    methods
        ...
        % Constractor
        function obj = Synthesis1dSystem(varargin)
            setProperties(obj,nargin,varargin{:})
            if isempty(obj.SynthesisFilters) 
                obj.nChs = 1;
            else
                obj.nChs = size(obj.SynthesisFilters,2);
            end
        end
