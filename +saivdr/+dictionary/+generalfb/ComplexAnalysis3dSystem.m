classdef ComplexAnalysis3dSystem < saivdr.dictionary.AbstAnalysisSystem
    %COMPLEXANALYSIS3DSYSTEM Abstract class of 3-D analysis system
    %
    % Reference:
    ...
    methods
        % Constractor
        function obj = ComplexAnalysis3dSystem(varargin)
