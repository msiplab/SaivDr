classdef PolyPhaseMatrix1d < handle
    %POLYPHASEMATRIX1D 1-D polyphase matrix
    %
    % SVN identifier:
    % $Id: PolyPhaseMatrix2d.m 397 2014-09-11 02:25:54Z sho $
    %
    ...
    methods
        function obj = PolyPhaseMatrix1d(input)
            if nargin == 1
                if isa(input,'saivdr.dictionary.utility.PolyPhaseMatrix1d')
        ...
        function value = plus(obj,another)
            ...
            if (ndims(coef1) == ndims(coef2) && ...
                ...
                value = PolyPhaseMatrix1d(coef1+coef2);
            else
        ...
        function value = ctranspose(obj)
            ...
            value = PolyPhaseMatrix1d(coefTmp);
        end
