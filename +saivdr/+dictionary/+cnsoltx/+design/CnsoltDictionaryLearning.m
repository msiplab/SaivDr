classdef CnsoltDictionaryLearning < matlab.System
    ...
    properties (Nontunable)
        ...
        DictionaryUpdater = 'CnsoltDictionaryUpdateGaFmin'
    ...
    properties (Hidden, Transient)
        ...
        DictionaryUpdaterSet = ...
            matlab.system.StringSet({'CnsoltDictionaryUpdateGaFmin','CnsoltDictionaryUpdateSgd'});
    ...
    methods
        function obj = CnsoltDictionaryLearning(varargin)
            ...
            if strcmp(obj.NumberOfDimensions,'Three')
                ...
                obj.OvsdLpPuFb = CnsoltFactory.createCplxOvsdLpPuFb3dSystem(...
                ...
                obj.OvsdLpPuFb = CnsoltFactory.createCplxOvsdLpPuFb2dSystem(...
                    'DecimationFactor',obj.DecimationFactor,...%obj.nDecs,...
                    'NumberOfChannels', [obj.NumberOfSymmetricChannel obj.NumberOfAntisymmetricChannel ],...
                    'PolyPhaseOrder',obj.NumbersOfPolyphaseOrder,...
                    'NumberOfVanishingMoments',obj.OrderOfVanishingMoment,...
    ...
    methods (Access=protected)
        ...
        function flag = isInactivePropertyImpl(obj,propertyName)
            ...
            elseif strcmp(propertyName,'SgdStep') || ...
                ...
                flag = ~strcmp(obj.DictionaryUpdater,'CnsoltDictionaryUpdateSgd');
            else
                flag = false;
            end
        end
        ...
        function setupImpl(obj, ~, ~)
            ...
            if strcmp(obj.NumberOfDimensions,'Three')
                synthesizer = CnsoltFactory.createSynthesis3dSystem(...
                    obj.OvsdLpPuFb,...
                    'IsCloneLpPuFb3d',false);    
                analyzer = CnsoltFactory.createAnalysis3dSystem(...
                    obj.OvsdLpPuFb,...
                    'IsCloneLpPuFb3d',false);                    
            else
                synthesizer = CnsoltFactory.createSynthesis2dSystem(...
                    obj.OvsdLpPuFb,...
                    'IsCloneLpPuFb2d',false);                    
                analyzer = CnsoltFactory.createAnalysis2dSystem(...
                    obj.OvsdLpPuFb,...
                    'IsCloneLpPuFb2d',false);
            end
            ...
            if strcmp(obj.DictionaryUpdater,'CnsoltDictionaryUpdateSgd')
                import saivdr.dictionary.cnsoltx.design.CnsoltDictionaryUpdateSgd
                obj.dicUpdate = CnsoltDictionaryUpdateSgd(...
                ...
                import saivdr.dictionary.cnsoltx.design.CnsoltDictionaryUpdateGaFmin
                obj.dicUpdate = CnsoltDictionaryUpdateGaFmin(...
                    'SourceImages', obj.SourceImages,...
                    'NumberOfTreeLevels',obj.NumberOfTreeLevels,...
