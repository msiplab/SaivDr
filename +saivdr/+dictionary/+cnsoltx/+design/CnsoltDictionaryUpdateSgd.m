classdef CnsoltDictionaryUpdateSgd < ...
        saivdr.dictionary.cnsoltx.design.AbstCnsoltDesigner %#~codegen
    ...
    methods
        ...
        function obj = CnsoltDictionaryUpdateSgd(varargin)
    ...
    methods (Access=protected)
        ...
        function s = saveObjectImpl(obj)
            s = saveObjectImpl@saivdr.dictionary.cnsoltx.design.AbstCnsoltDesigner(obj);
            s.aprxError = matlab.System.saveObject(obj.aprxError);
        end
        
        function loadObjectImpl(obj,s,wasLocked)
            obj.aprxError = matlab.System.loadObject(s.aprxError);
            loadObjectImpl@saivdr.dictionary.cnsoltx.design.AbstCnsoltDesigner(obj,s,wasLocked);
        end
        ...
        function setupImpl(obj,lppufb_,options)
            setupImpl@saivdr.dictionary.cnsoltx.design.AbstCnsoltDesigner(...
                obj,lppufb_,options);
            ...
            obj.aprxError = AprxErrorWithSparseRep(...
                ...
                'Stochastic','on');
            if obj.IsVerbose
                fprintf('(CnsoltDictionaryUpdateSgd) IsFixedCoefs = %d\n', ...
