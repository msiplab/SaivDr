function [fcnhandler,flag] = fcn_autobuild_gradevalsteps2d(nch,ord)
%%FCN_AUTOBUILD_GRADEVALSGTEPS2D
%
% SVN identifier:
% $Id: fcn_autobuild_vqstep2d.m 777 2015-09-20 00:58:29Z sho $
%
...
%global isAutoBuildAtomCnc2dLocked
%if isempty(isAutoBuildAtomCnc2dLocked)
%    isAutoBuildAtomCnc2dLocked = false;
%end

bsfname = 'fcn_GradEvalSteps2d';
mexname = sprintf('%s_cs%da%d_ov%dh%d_mex',bsfname,...
    nch(1),nch(2),ord(1),ord(2));
...
%if ~isAutoBuildAtomCnc2dLocked
%    isAutoBuildAtomCnc2dLocked = true;
