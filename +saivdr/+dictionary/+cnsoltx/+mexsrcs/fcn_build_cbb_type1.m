function [fcnhandler,flag] = fcn_build_cbb_type1()
...
bsfname = 'fcn_Order1CplxBuildingBlockTypeI';
...
if license('checkout','matlab_coder') % Coder is available
    ...
    if fbsfile == 2
        ...
        paramMtxW  = coder.typeof(double(0),[inf inf],[1 1]); %#ok
        paramMtxU  = coder.typeof(double(0),[inf inf],[1 1]); %#ok
        paramAngles = coder.typeof(double(0),[inf 1],[0 0]); %#ok
        ...
        args = '{ arrayCoefs, paramMtxW, paramMtxU, paramAngles, aHChs, nshift }';
