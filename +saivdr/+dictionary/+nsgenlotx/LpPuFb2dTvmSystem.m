classdef LpPuFb2dTvmSystem < saivdr.dictionary.nsoltx.AbstOvsdLpPuFb2dTypeISystem
    ...
    methods (Access = protected)
        ...
        function updateParameterMatrixSet_(obj)
            ...
            for iParamMtx=uint32(1):nStages+1
                U = step(obj.omgs_,angles(:,iParamMtx),mus(:,iParamMtx));
        ...
        function updateParameterMatricesTvmHorizontal_(obj)
            ...
            mus(1,iParamMtx) = 1;
            %
            A = step(obj.omgs_,angles(:,iParamMtx),mus(:,iParamMtx));
            angle_ = step(obj.ops_, obj.x3_);
            P = step(obj.omgs_,angle_,1);
            Vb = A*P;
            step(obj.ParameterMatrixSet,Vb,iParamMtx);
            ...
            Va = step(obj.omgs_,angles(:,iParamMtx),mus(:,iParamMtx));
            step(obj.ParameterMatrixSet,Va,iParamMtx);
            iParamMtx = iParamMtx + 1;
