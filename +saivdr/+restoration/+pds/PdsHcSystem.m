classdef PdsHcSystem < saivdr.restoration.AbstIterativeMethodSystem
    % PDSHCSYSTEM Signal restoration via primal-dual splitting method
    %
    % Problem setting:
    %
    %    r^ = Dx^
    ...
    %
    % ===================================================================
    %  Primal-dual spliting (PDS) method
    % -------------------------------------------------------------------
    % Input:  x(0), y(0)
    % Output: r(n)
    %  1: n = 0
    ...
    methods
        function obj = PdsHcSystem(varargin)
